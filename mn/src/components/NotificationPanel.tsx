...
export function NotificationPanel({ isOpen, onClose }: NotificationPanelProps) {
  ...
  const notifications = [
    {
      ...
      title: "Order Shipped",
      message:
        "Your Diamond Tennis Bracelet has been shipped and will arrive in 2-3 days.",
      time: "2 hours ago",
      unread: true,
    },
    {
    ...
    },
    {
      ...
      message:
        "How did you like your Pearl Earrings? Leave a review and get 10% off your next order.",
      time: "1 day ago",
      unread: false,
    },
    {
      ...
      title: "Special Offer",
      message:
        "Enjoy 20% off on all necklaces this weekend. Use code SPARKLE20.",
      time: "2 days ago",
      unread: false,
    },
  ];
  ...
  return (
    // <div className="fixed inset-0 z-50 overflow-hidden border-3 border-black">
    //   {/* Backdrop */}
    //   <div
    ...
    //   {/* Panel */}
    //   <div className="absolute right-0 top-0 h-screen max-w-md bg-manzarri-white shadow-2xl">
    ...
    //                       ? "bg-manzarri-green/20 text-manzarri-green"
    //                       : notification.type === "wishlist"
    //                       ? "bg-manzarri-reddish-brown/20 text-manzarri-reddish-brown"
    //                       : notification.type === "review"
    //                       ? "bg-manzarri-faun/20 text-manzarri-faun"
    ...
    //                       <Badge
    //                         variant="secondary"
    //                         className="w-2 h-2 p-0 bg-manzarri-reddish-brown"
    //                       />
    //                     )}
    //                   </div>
    ...
    <div className="fixed inset-0 z-50 overflow-hidden border-3 border-black">
      ...
      {/* Panel */}
      <div className="absolute right-0 top-0 h-full max-w-md w-full bg-manzarri-white shadow-2xl flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-manzarri-black/10 px-6 py-4">
          <h2 className="text-xl font-semibold text-manzarri-black">
            Notifications
