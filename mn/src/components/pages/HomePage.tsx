...
export function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'All diamonds and gemstones are certified by leading authorities'
    },
    {
      icon: Star,
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-manzarri-black/80 mb-8 leading-relaxed">
              Discover our exquisite collection of handcrafted jewelry. Each piece tells a story of luxury, passion, and timeless beauty.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/marketplace">
                <Button size="lg" className="bg-manzarri-reddish-brown hover:bg-manzarri-reddish-brown/90 text-manzarri-white px-8 py-6">
                  Explore Collection
      ...
      <section className="py-20 bg-manzarri-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-manzarri-black mb-4">Shop by Category</h2>
            <p className="text-xl text-manzarri-black/70">Find the perfect piece for every occasion</p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {categories.map((category, index) => (
              <Card key={index} className="group cursor-pointer hover:shadow-lg transition-all duration-300 border-manzarri-black/10">
      ...
      <section className="py-20 bg-manzarri-skin/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-manzarri-black mb-4">Featured Collection</h2>
            <p className="text-xl text-manzarri-black/70">Handpicked pieces that define luxury</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredProducts.map((product) => (
              <Card key={product.id} className="group cursor-pointer overflow-hidden border-manzarri-black/10 hover:shadow-xl transition-all duration-300">
                <div className="relative">
                  ...
                  <Badge 
                    className={`absolute top-4 left-4 ${
                      product.badge === 'Bestseller' ? 'bg-manzarri-reddish-brown' :
                      product.badge === 'New' ? 'bg-manzarri-green' : 'bg-manzarri-faun'
                    } text-manzarri-white`}
                  >
                    {product.badge}
                  </Badge>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    <span className="text-sm text-manzarri-black/60 ml-2">({product.reviews})</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <span className="text-2xl font-bold text-manzarri-reddish-brown">{product.price}</span>
                      <span className="text-lg text-manzarri-black/50 line-through">{product.originalPrice}</span>
                    </div>
                    <Button size="sm" className="bg-manzarri-black hover:bg-manzarri-black/90 text-manzarri-white">
                      Add to Cart
                    </Button>
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            <Link to="/marketplace">
              <Button size="lg" variant="outline" className="border-manzarri-reddish-brown text-manzarri-reddish-brown hover:bg-manzarri-reddish-brown hover:text-manzarri-white">
                View All Products
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
      ...
      <section className="py-20 bg-manzarri-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-manzarri-black mb-4">Why Choose Manzarri</h2>
            <p className="text-xl text-manzarri-black/70">Excellence in every detail</p>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="text-center group">
                  ...
                  <h3 className="text-xl font-semibold text-manzarri-black mb-3">{feature.title}</h3>
                  <p className="text-manzarri-black/70 leading-relaxed">{feature.description}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-manzarri-reddish-brown to-manzarri-faun">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-manzarri-white mb-6">Join Our Exclusive Club</h2>
          <p className="text-xl text-manzarri-white/90 mb-8 max-w-2xl mx-auto">
            Be the first to discover new collections, enjoy member-only discounts, and receive personalized jewelry recommendations.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <Link to="/signup" className="flex-1">
              <Button size="lg" className="w-full bg-manzarri-white text-manzarri-reddish-brown hover:bg-manzarri-white/90">
                Sign Up Now
              </Button>
            </Link>
            <Link to="/login" className="flex-1">
              <Button size="lg" variant="outline" className="w-full border-manzarri-white text-manzarri-white hover:bg-manzarri-white hover:text-manzarri-reddish-brown">
                Login
              </Button>
            </Link>
          </div>
