      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-3xl font-bold text-manzarri-black">Manzarri</span>
          </Link>
          <p className="text-manzarri-black/70 mt-2">Join our exclusive jewelry community</p>
        </div>

        <Card className="border-manzarri-black/10 shadow-xl">
          <div className="p-8">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold text-manzarri-black mb-2">Create Account</h1>
              <p className="text-manzarri-black/70">Start your journey with luxury jewelry</p>
            </div>

            <form className="space-y-6">
              {/* Name Field */}
              <div>
                <Label htmlFor="name" className="text-manzarri-black">Full Name</Label>
              ...
              {/* Email Field */}
              <div>
                <Label htmlFor="email" className="text-manzarri-black">Email Address</Label>
                <div className="relative mt-2">
              ...
              {/* Password Field */}
              <div>
                <Label htmlFor="password" className="text-manzarri-black">Password</Label>
                <div className="relative mt-2">
              ...
              <div className="flex items-start space-x-3">
                ...
                <Label htmlFor="terms" className="text-sm text-manzarri-black/70 leading-relaxed">
                  I agree to the{' '}
                  <Link to="/terms" className="text-manzarri-reddish-brown hover:text-manzarri-reddish-brown/80">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-manzarri-reddish-brown hover:text-manzarri-reddish-brown/80">
                    Privacy Policy
                  </Link>
                </Label>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <Label htmlFor="newsletter" className="text-sm text-manzarri-black/70 leading-relaxed">
        ...
        <Card className="mt-6 border-manzarri-black/10 bg-gradient-to-r from-manzarri-skin/10 to-manzarri-faun/10">
          <div className="p-6">
            <h3 className="font-semibold text-manzarri-black mb-4 text-center">Member Benefits</h3>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-manzarri-reddish-brown rounded-full"></div>
                <span className="text-sm text-manzarri-black/80">Exclusive access to new collections</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-manzarri-reddish-brown rounded-full"></div>
                <span className="text-sm text-manzarri-black/80">Free shipping on orders over $500</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-manzarri-reddish-brown rounded-full"></div>
                <span className="text-sm text-manzarri-black/80">Personalized jewelry recommendations</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-manzarri-reddish-brown rounded-full"></div>
                <span className="text-sm text-manzarri-black/80">Priority customer support</span>
              </div>
            </div>
          </div>
        </Card>
