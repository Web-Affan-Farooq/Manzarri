    ...
    <div className="min-h-screen bg-gradient-to-br from-manzarri-skin/20 to-manzarri-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="border-manzarri-black/10 shadow-xl">
          <div className="p-8">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold text-manzarri-black mb-2">Sign In</h1>
              <p className="text-manzarri-black/70">Access your account to continue shopping</p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="remember" className="text-sm text-manzarri-black/70">
                    Remember me
                  </Label>
                </div>
                <Link 
