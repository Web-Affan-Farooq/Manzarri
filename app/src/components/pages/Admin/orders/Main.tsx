    ...
    <>
      ...
      <section className="p-6 w-full h-screen overflow-y-auto gray-scroller">
        ...
        <select
          name="selectMonth"
          id="select-month"
          className="w-[150px] px-3 py-1 rounded-md"
          onChange={handleMonthFilter}
          value={currentMonth}
        >
          <option value="1" className="bg-black text-white text-sm">
            January
          </option>
          <option value="2" className="bg-black text-white text-sm">
            February
          </option>
          <option value="3" className="bg-black text-white text-sm">
            March
          </option>
          <option value="4" className="bg-black text-white text-sm">
            April
          </option>
          <option value="5" className="bg-black text-white text-sm">
            May
          </option>
          <option value="6" className="bg-black text-white text-sm">
            June
          </option>
          <option value="7" className="bg-black text-white text-sm">
            July
          </option>
          <option value="8" className="bg-black text-white text-sm">
            August
          </option>
          <option value="9" className="bg-black text-white text-sm">
            September
          </option>
          <option value="10" className="bg-black text-white text-sm">
            October
          </option>
          <option value="11" className="bg-black text-white text-sm">
            November
          </option>
          <option value="12" className="bg-black text-white text-sm">
            December
          </option>
        </select>
