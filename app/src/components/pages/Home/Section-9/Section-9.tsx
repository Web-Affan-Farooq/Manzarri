  ...
  return (
    <section className="w-full py-20 px-5 text-center">
      ...
      <div className="flex flex-row flex-wrap justify-center align-middle gap-10">
        <Image
          src={"/images/section-9-images/1.svg"}
          alt="model image"
          width={150}
          height={150}
        ...
        />
        <Image
          src={"/images/section-9-images/2.svg"}
          alt="model image"
          width={150}
          height={150}
          className="object-cover rounded-lg"
        />
        <Image
          src={"/images/section-9-images/3.svg"}
          alt="model image"
          width={150}
          height={150}
          className="object-cover rounded-lg"
        />
        <Image
          src={"/images/section-9-images/4.svg"}
          alt="model image"
          width={150}
          height={150}
          className="object-cover rounded-lg"
        />
        <Image
          src={"/images/section-9-images/5.svg"}
          alt="model image"
          width={150}
          height={150}
          className="object-cover rounded-lg"
